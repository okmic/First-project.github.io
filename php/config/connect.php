...
define('HOST', 'a367487.mysql.mchost.ru');
define('USER', 'a367487_1');
define('PASSWORD', '78AVexjCrrth');
define('DATABASE', 'a367487_1');

/*
 * Подключаемся к базе данных с помощью функции mysqli_connect()
 */

$connect = mysqli_connect(HOST, DATABASE, USER, PASSWORD);
